...
@section('page_title', 'Create Customer Profile')
@section('page_subtitle', 'Register a new customer or corporate account')
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" value="{{ old('company_name') }}" required placeholder="e.g. BlazeGuard Fire Protection Pvt Ltd">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2" required placeholder="Plot 42, Fire Safety Industrial Complex, Zip 400001">{{ old('address') }}</textarea>
                ...
                <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle me-1"></i> Save Customer</button>
                </div>
            </form>
        </div>
    </div>
