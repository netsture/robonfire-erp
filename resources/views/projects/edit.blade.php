...
@section('title', 'Edit Project Entry')
@section('page_title', 'Edit Project Entry')
@section('page_subtitle', 'Update project details, PO number, date, and amount')
    ...
    <div class="col-12 col-lg-8">
        <div class="card card-custom border-0 p-4">
            <form action="{{ route('projects.update', $project) }}" method="POST">
                ...
                <h5 class="fw-bold font-outfit text-dark mb-4">Edit Project Information</h5>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('project_name') is-invalid @enderror" id="project_name" name="project_name" value="{{ old('project_name', $project->project_name) }}" required placeholder="e.g. Metro Line 3 Fire Safety Installation">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('po_number') is-invalid @enderror" id="po_number" name="po_number" value="{{ old('po_number', $project->po_number) }}" required placeholder="e.g. PO-2026-8891">
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control datepicker-ddmmyyyy @error('po_date') is-invalid @enderror" id="po_date" name="po_date" value="{{ old('po_date', $project->po_date ? $project->po_date->format('Y-m-d') : '') }}" required>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" min="0" class="form-control @error('po_amount') is-invalid @enderror" id="po_amount" name="po_amount" value="{{ old('po_amount', $project->po_amount) }}" required placeholder="e.g. 150000.00">
                        </div>
