    ...
    <div class="col-12 col-lg-8">
        <div class="card card-custom border-0 p-4 h-100">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge bg-light text-dark border px-3 py-2 rounded-pill">Year 2026</span>
            </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="card card-custom border-0 p-4 h-100">
            ...
            <div class="list-group list-group-flush gap-2 border-0">
                ...
                <a href="{{ route('reports.index') }}" class="list-group-item list-group-item-action border rounded-3 p-3 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <div class="rounded-circle bg-warning bg-opacity-10 p-2 me-3 text-warning">
                            <i class="bi bi-file-earmark-bar-graph fs-5"></i>
                        </div>
                        <div>
                            <div class="fw-semibold text-dark">Financial Reports</div>
                            <div class="text-muted small">Profit & Loss, Stock valuation</div>
                        </div>
                    </div>
                    <i class="bi bi-chevron-right text-muted"></i>
                </a>
