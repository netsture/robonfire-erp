...
@section('page_subtitle', 'Update role details and manage assigned permissions')
            ...
            <form action="{{ route('roles.update', $role) }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description', $role->description) }}">
                ...
                <div class="border-top pt-4 mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <span class="text-muted small">Select or uncheck allowed actions</span>
                        </div>
                        <button type="button" id="selectAllBtn" class="btn btn-sm btn-outline-primary rounded-pill px-3">Toggle All</button>
                    </div>
