            ...
            <div class="card card-custom border-0 p-4 mb-3">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control @error('project_name') is-invalid @enderror" id="project_name" name="project_name" value="{{ old('project_name') }}" placeholder="e.g. Metro Safety Expansion" required>
                        @error('project_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="vehicle_number" class="form-label fw-semibold text-dark">Vehicle Number <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('vehicle_number') is-invalid @enderror" id="vehicle_number" name="vehicle_number" value="{{ old('vehicle_number') }}" placeholder="e.g. MH 12 AB 1234" required>
                        ...
                        <tbody id="itemsContainer">
                            @if(old('products'))
                                @foreach(old('products') as $index => $oldProduct)
                                    ...
                                    <tr class="item-row">
                                        ...
                                        <td>
                                            <input type="number" step="0.01" name="products[{{ $index }}][price]" class="form-control form-control-sm price-input" value="{{ $oldProduct['price'] ?? '0.00' }}" required>
                                        </td>
                                        <td>
                            ...
                            @else
                                <tr class="item-row">
                                    ...
                                    <td>
                                        <input type="number" step="0.01" name="products[0][price]" class="form-control form-control-sm price-input" value="0.00" required>
                                    </td>
                                    <td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('addRowBtn').addEventListener('click', function () {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    <input type="number" step="0.01" name="products[${rowCount}][price]" class="form-control form-control-sm price-input" value="0.00" required>
                </td>
                <td>
